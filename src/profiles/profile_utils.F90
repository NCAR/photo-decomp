...
module tuvx_profile_utils
  ...
  ! integer(ik), external :: julian_day_of_year
  ! real(dk),    external :: earth_sun_distance

  public :: julian_day_of_year, earth_sun_distance, is_leap
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function earth_sun_distance( YEAR, DAY, HOUR, LAT, LONG ) result( soldst )
